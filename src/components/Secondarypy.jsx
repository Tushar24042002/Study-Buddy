    ...
    return (
        ...
        <div>
            <Helmet>
                ...
                <title>{"Best Learning Platform Study Buddy - " + props.class}</title>
                <link rel="canonical" href={"https://www.studybuddy.store/" + props.class} />
                ...
                <meta name="twitter:description"
                    content="Studybuddy is a platform for students to access their notes, syllabus, deleted syllabus, answers solutions, sample paper and previous year papers in pdf form." />
                <meta property="og:url" content={"https://www.studybuddy.store/" + props.class} />



            </Helmet>
            <section className='parts'>
                <CourseHeading heading={props.class + " Previous Year Papers"} subheading="All Classes" />
                <div className="container py-5">
                    <div className="title mb-3"> {props.class} Previous Year Papers</div>
                    <div className="row">
