...
function Course12() {
  ...
  useEffect(() => {
    const getComments = async () => {
      const res = await fetch(
        `  https://my-json-server.typicode.com/tushargupta24/practice/courses-12?_page=1&_limit=${limit}`
  ...
  const fetchComments = async (currentPage) => {
    const res = await fetch(
      ...
      `  https://my-json-server.typicode.com/tushargupta24/practice/courses-12?_page=${currentPage}&_limit=${limit}`
...
<title>Best Learning Platform Study Buddy - Sample Paper Class 12</title>
<link rel="canonical" href="https://www.studybuddy.store/courses-12/" />
...
{/* <title>Best Learning Platform Study Buddy - Sample Paper Class 12</title> */}
<meta name="title" content="Best Learning Platform Study Buddy - Sample Paper Class 12" />
...
<meta property="og:title" content="Best Learning Platform Study Buddy - Sample Paper Class 12" />
...
<meta name="twitter:title" content="Best Learning Platform Study Buddy - Sample Paper Class 12" />
<meta name="twitter:description"
  content="Studybuddy is a platform for students to access their notes, syllabus, deleted syllabus, answers solutions, sample paper and previous year papers in pdf form." />
<meta property="og:url" content="https://www.studybuddy.store/courses-12/" />



</Helmet>
      <CourseHeading heading="class 12th Page" subheading="Course page 12Th Class"/>
