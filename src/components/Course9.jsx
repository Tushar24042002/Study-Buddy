...
function Course9() {
  ...
  useEffect(() => {
    const getComments = async () => {
      const res = await fetch(
        `  https://my-json-server.typicode.com/tushargupta24/practice09/courses-9?_page=1&_limit=${limit}`
  ...
  const fetchComments = async (currentPage) => {
    const res = await fetch(
      ...
      `  https://my-json-server.typicode.com/tushargupta24/practice09/courses-9?_page=${currentPage}&_limit=${limit}`
...
<title>Best Learning Platform Study Buddy - Sample Paper Class 9</title>
<link rel="canonical" href="https://www.studybuddy.store/courses-9/" />
...
{/* <title>Best Learning Platform Study Buddy - Sample Paper Class 9</title> */}
<meta name="title" content="Best Learning Platform Study Buddy - Sample Paper Class 9" />
...
<meta property="og:title" content="Best Learning Platform Study Buddy - Sample Paper Class 9" />
...
<meta name="twitter:title" content="Best Learning Platform Study Buddy - Sample Paper Class 9" />
<meta name="twitter:description"
  content="Studybuddy is a platform for students to access their notes, syllabus, deleted syllabus, answers solutions, sample paper and previous year papers in pdf form." />
<meta property="og:url" content="https://www.studybuddy.store/courses-9/" />



</Helmet>
      <CourseHeading heading="class 10th Page" subheading="Course page 10Th Class"/>
