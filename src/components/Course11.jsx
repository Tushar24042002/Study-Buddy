...
function Course11() {
  ...
  useEffect(() => {
    const getComments = async () => {
      const res = await fetch(
        `   https://my-json-server.typicode.com/tushargupta24/practice11/course-11?_page=1&_limit=${limit}`
  ...
  const fetchComments = async (currentPage) => {
    const res = await fetch(
      ...
      `  https://my-json-server.typicode.com/tushargupta24/practice11/course-11?_page=${currentPage}&_limit=${limit}`
  ...
  const lengthApi = async () => {
    const response = await fetch(
      ...
      " https://my-json-server.typicode.com/tushargupta24/practice11/course-11"
      // `https://jsonplaceholder.typicode.com/comments?_page=${currentPage}&_limit=${limit}`
    );
...
<title>Best Learning Platform Study Buddy - Sample Paper Class 11</title>
<link rel="canonical" href="https://www.studybuddy.store/courses-11/" />
...
{/* <title>Best Learning Platform Study Buddy - Sample Paper Class 11/title> */}
<meta name="title" content="Best Learning Platform Study Buddy - Sample Paper Class 11" />
...
<meta property="og:title" content="Best Learning Platform Study Buddy - Sample Paper Class 11" />
...
<meta name="twitter:title" content="Best Learning Platform Study Buddy - Sample Paper Class 11" />
<meta name="twitter:description"
  content="Studybuddy is a platform for students to access their notes, syllabus, deleted syllabus, answers solutions, sample paper and previous year papers in pdf form." />
<meta property="og:url" content="https://www.studybuddy.store/courses-11/" />



</Helmet>
      <CourseHeading heading="class 11th Page" subheading="Course page 11Th Class"/>
