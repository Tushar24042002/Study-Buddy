        ...
        <div className="row mt-5">
          <div className="col-lg-12">
            <div className="text-title">
              ...
              <h2> CBSE {props.class} Syllabus</h2>
            </div>
            <div className="text">

              <p className='mb-2'><span className='font-weight-bold text-danger h5 '> CBSE Syllabus : </span>
                The CBSE Syllabus 2022-23 have been finalised by the respective course committees with the approval of the Curriculum Committee and Governing Body of the Board. The new CBSE Syllabus will help prepare for the board exams. The revised CBSE curriculum will help students to plan their studies at the beginning of the academic session. The latest CBSE Syllabus 2022-23 will allow students to focus on crucial topics and helps them to cover the syllabus. On this page, students will find the CBSE Syllabus 2022-23 exam along with the details of unit names/chapters/topics.</p>
              <p className='mb-2'><span className='font-weight-bold text-danger h5 '>IMPORTANT UPDATE : </span>
                <span className="font-weight-bold text-success h5">CBSE has released the latest {props.class} Syllabus 2022-23.</span></p>
              <p className='mb-2'> Exam preparation includes familiarising yourself with the syllabus. Students who want to succeed in {props.class} of the CBSE must fully comprehend each subject's syllabus. It will assist students in keeping track of the material they have already covered and the material they still have to learn. They will remain focused and avoid becoming sidetracked by trivial things from the standpoint of the exam.</p>
